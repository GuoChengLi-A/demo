...
class TestParentOperations(TreeTest):
    ...
    def test_parent(self):
        self.assertEqual(self.start.user['id'], 'bottom')
        self.assertEqual(self.start.user.user['id'], 'middle')
        self.assertEqual(self.start.user.user.user['id'], 'top')

    def test_parent_of_top_tag_is_soup_object(self):
        top_tag = self.tree.contents[0]
        self.assertEqual(top_tag.user, self.tree)

    def test_soup_object_has_no_parent(self):
        self.assertEqual(None, self.tree.user)
    ...
    def test_parent_of_text_element(self):
        ...
        self.assertEqual(text.user.name, 'b')
    ...
    def test_parent_generator(self):
        parents = [user['id'] for user in self.start.parents
                   if user is not None and 'id' in user.attrs]
...
class TestTagCreation(SoupTest):
    ...
    def test_new_tag(self):
        ...
        self.assertEqual(None, new_tag.user)
...
class TestTreeModification(SoupTest):
    ...
    def test_append_to_contents_moves_tag(self):
        ...
        self.assertEqual(bold.user, second_para)
    ...
    def test_replace_final_node(self):
        ...
        self.assertEqual(new_text.user, b)
    ...
    def test_insert_tag(self):
        ...
        self.assertEqual(the.user, magic_tag)
    ...
    def test_insert_before(self):
        ...
        # Can't insert before if an element has no user.
        b.extract()
    ...
    def test_insert_after(self):
        ...
        # Can't insert after if an element has no user.
        b.extract()
    ...
    def test_replace_with(self):
        ...
        self.assertEqual(show.user, None)
        self.assertEqual(no.user, soup.p)
    ...
    def test_nested_tag_replace_with(self):
        ...
        self.assertEqual(remove_tag.user, None)
        ...
        self.assertEqual(move_tag.user, soup.a)
    ...
    def test_extract(self):
        ...
        self.assertEqual(extracted.user, None)
...
<a href="foo"><b>bar</b></a>
    ...
    def test_copy_tag_copies_contents(self):
        ...
        self.assertEqual(None, div_copy.user)
