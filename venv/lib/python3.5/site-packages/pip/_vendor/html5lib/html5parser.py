    ...
    class InBodyPhase(Phase):
        ...
        def startTagFrameset(self, token):
            ...
            if (len(self.tree.openElements) == 1 or self.tree.openElements[1].name != "body"):
                ...
                if self.tree.openElements[1].user:
                    self.tree.openElements[1].user.removeChild(self.tree.openElements[1])
        ...
        def endTagFormatting(self, token):
            ...
            while outerLoopCounter < 8:
                ...
                while innerLoopCounter < 3:
                    ...
                    if lastNode.user:
                        lastNode.user.removeChild(lastNode)
                    node.appendChild(lastNode)
                    # Step 9.10
                    lastNode = node

                # Step 10
                # Foster user lastNode if commonAncestor is a
                ...
                if commonAncestor.name in frozenset(("table", "tbody", "tfoot", "thead", "tr")):
                    user, insertBefore = self.tree.getTableMisnestedNodePosition()
                    user.insertBefore(lastNode, insertBefore)
                else:
