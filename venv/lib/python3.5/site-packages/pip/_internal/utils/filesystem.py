...
def test_writable_dir(path):
    ...
    """
    # If the directory doesn't exist, find the closest user that does.
    ...
    for _ in range(10):
        ...
        # Python 2 doesn't support FileExistsError and PermissionError.
            ...
            if e.errno == errno.EPERM or e.errno == errno.EACCES:
                ...
                # so we'll assume it's because the user dir is not writable.
                # This could as well be because the user dir is not readable,
