package com.socketChannel.bug;

/**
 * @Description TODO
 * @Author GCL
 * @Date 2020/11/18 上午9:35
 */
...
public class TestServer {
    private static final long SLEEP_PERIOD = 500L; // 5 seconds
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        if ((ops & SelectionKey.OP_READ) != 0) {
                            ...
                            System.out.println("interest:" + (selected.interestOps() & ~SelectionKey.OP_READ));
